...
ㅇ) 단순 저가매수 / 고가매도 (get_entry_date.change_recent 함수) 에 대해서
    1) 각각 저가매수 / 고가매도 최적의 n%
    2) 콜쪽 풋쪽 각각 제일 나은 전략이 뭔지 > 네이키드 매수 / 매도 / 데빗 / 레이쇼 / 버터플
    콜쪽은 ratio spread 가 promising 해보이고...
...
ㅇ) 매도전략 손절치고나서 반등포지셔닝
     1) 백스프레드
     2) 레이쇼

ㅇ) 상시 Laddering 해놓는 전략
    1) BSH
    1) Zero Cost Butterfly

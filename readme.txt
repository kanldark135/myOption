...
ㅇ) 상시 Laddering 해놓는 전략
    - BSH
        - 근월물 vs 차월물
        차월물이 양매도 날리고 나서도 더 오래가는게 있으나... 1) 거래 부진 / 2) 호가 문제 / 3) 세타가 낮아 반대쪽 포지션 구축에 오래 걸림 
        -> 급한대로 동일월물로 먼저 만들고 차월로 롤링?
        - 차월물 -30 네이키드 보다는 일단 근월물 -30/60 + 차월물 -30 이 조금 덜 노출되있다는 느낌...?
        -> 보통 차월물 양매도가 익절이든 손절이든 나는데 한 달은 걸림...
        => 다만 경과후 헤지는 한달짜리로 전락... 그 자체로 의미가 있나?

...
strangle_entry = get_date_intersect(df_weekly, weekday_entry(df_weekly, [4]))
...
strangle_entry = get_date_intersect(df_monthly, weekday_entry(df_monthly, [0, 4]), no_lowvol)
...
#1. 진입조건
put_entry = get_date_intersect(df_weekly, weekday_entry(df_weekly, [0]))
...
stoch_turndown1 = k200.stoch.rebound1(pos = 's', k = 5, d = 3, smooth_d = 3)
stoch_turndown2 = k200.stoch.rebound1(pos = 's', k = 10, d = 5, smooth_d = 5)

stoch_turnup1 = k200.stoch.rebound1(pos = 'l', k = 5, d = 3, smooth_d = 3)
stoch_turnup2= k200.stoch.rebound1(pos = 'l', k = 10, d = 5, smooth_d = 5)
...
call_entry = get_date_intersect(df_monthly, bbands_turnup2)
...
entry_condition = [
    ...
    dict(entry9 = get_date_intersect(df_monthly, psar_turnup)),
    dict(entry10 = get_date_intersect(df_monthly, supertrend_turnup)),
    dict(entry11 = get_date_intersect(df_monthly, bbands_turnup2)),
    dict(entry12 = get_date_intersect(df_monthly, stoch_turnup2))
    ]

...
# df_ret = pd.read_excel("./전략결과(240530).xlsx", sheet_name = 'total', usecols = "DN:FE", skiprows = [0]) : 위클리
...
w_list = np.linspace(0, 1.2, 121) # initial value 에 따른 차이

...
df_monthly = pd.read_excel("./전략결과(240324).xlsx", sheet_name = 'total', usecols = "BQ:FB", skiprows = [0])
...
df_weekly = pd.read_excel("./전략결과(240324).xlsx", sheet_name = 'total', usecols = "FD:HM", skiprows = [0])

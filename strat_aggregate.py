...
# df_monthly = pd.read_excel("./전략결과(240324).xlsx", sheet_name = 'total', usecols = "BF:DK", skiprows = [0])
df_monthly = pd.read_excel("./전략결과(240324).xlsx", sheet_name = 'total', usecols = "AZ:DC, DE:FJ", skiprows = [0])
...
df_pnl = df_pnl.diff(1).cumsum(axis = 0)
